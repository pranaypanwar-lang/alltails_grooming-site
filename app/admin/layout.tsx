        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-40">
          <div className="max-w-screen-2xl mx-auto flex items-center gap-6 px-5 h-12">
            ...
            <nav className="flex items-center gap-4 text-sm">
              ...
              <Link href="/admin/customers" className="text-gray-600 hover:text-gray-900 transition-colors">
                Customers
              </Link>
              ...
              <Link href="/admin/finance" className="text-gray-600 hover:text-gray-900 transition-colors">
                Finance
              </Link>
